...
// rawOrderPush — push data for the orders channel. The fill-related fields
...
The callback receives the list of orders delivered in a single push. Each
OrderInfo also carries the per-update execution fields (FillSize, FillPrice,
TradeID, ExecType, FillTimeMs, FillFee, FillFeeCcy, FillPnl, AmendResult,
CancelSource) — see types.OrderInfo.
*/
